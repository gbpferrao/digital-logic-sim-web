> Variant lens: this copy uses native basic primitives inside the same composed landmarks. The original storage/nand2tetris directory remains the NAND-derived comparison track.
